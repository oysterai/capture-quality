 ...
 */
import { DEFAULT_THRESHOLDS } from '../image-quality.js';
/**
 ...
 */
export function createFrameSampler(workingEdge = DEFAULT_THRESHOLDS.workingEdge) {
    let canvas = null;
    return {
        sample(video) {
...
//# sourceMappingURL=sample-frame.js.map