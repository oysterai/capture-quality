 ...
 */
export declare const IDEAL_CAPTURE_WIDTH = 1920;
export declare const IDEAL_CAPTURE_HEIGHT = 1080;
export declare function buildCameraConstraints(facingMode?: FacingMode): MediaStreamConstraints;
/** Request the camera at scan resolution. Rejects exactly as getUserMedia does. */
export declare function openCamera(facingMode?: FacingMode): Promise<MediaStream>;
/**
 ...
 */
export declare function attachStream(el: HTMLVideoElement, stream: MediaStream | null): Promise<void>;
